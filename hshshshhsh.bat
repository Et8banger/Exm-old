...
:a1
start https://discord.com/channels/1177410668606009444/1319811487216435251/1420126668869337178
echo.
echo.
echo.
echo.                                                                                  %b%╔═══════════════════════════════════════════════════════════════╗
...
echo.
echo.                                                                             %p%[%w%3%p%]%w% Uninstall Cortana / Copilot
echo.
echo.
...
echo.                                                                                                                               
echo.                                                  %p%[%w%7%p%]%w% Toggle Microsoft Store              %p%[%w%8%p%]%w% *Removed*
echo.
...
:r10
echo %w% - Fix fivem%b%
netsh int ip set global mldlevel=all >nul 2>&1
...
echo.                                                                                          
echo.                                                     %p%[%w%3%p%]%w% Revert Intel  Optimizations                           
echo.                                                                     
echo.                                                                                                                                                                                                          
echo.                                                             %p%[%w%M%p%]%w% Back to menu ⏩    
echo.                           
